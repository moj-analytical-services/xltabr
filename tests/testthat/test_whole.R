...
test_that("Simple test of dimensions, title", {
  ...
  # Check the rightmost column is reported correctly
  t1 = xltabr:::top_headers_get_rightmost_wb_col(tab_all_elements_no_offset) == 1
  t2 = xltabr:::top_headers_get_rightmost_wb_col(tab_no_top_headers) == 0
  t3 = xltabr:::top_headers_get_rightmost_wb_col(tab_all_elements_offset) == 4
  ...
  # Check that the cols are reported correctly
  t1 = xltabr:::top_headers_get_wb_cols(tab_all_elements_no_offset) == 1
  t2 = identical(xltabr:::top_headers_get_wb_cols(tab_no_top_headers), integer(0)) #Because you can't do integer(0) == integer(0)
  t3 = xltabr:::top_headers_get_wb_cols(tab_all_elements_offset) == 4
  ...
  # Check that the rows are reported correctly
  t1 = xltabr:::top_headers_get_wb_rows(tab_all_elements_no_offset) == 1:3
  t2 = identical(xltabr:::top_headers_get_wb_rows(tab_no_top_headers) ,integer(0))
  t3 = xltabr:::top_headers_get_wb_rows(tab_all_elements_offset) == 10:12
